## Based on Naru (Apache 2.0)
This project is an extended version of [Naru](https://github.com/naru-project/naru),
licensed under the Apache License 2.0.  
Additional components were added for index recommendation and query optimization.
